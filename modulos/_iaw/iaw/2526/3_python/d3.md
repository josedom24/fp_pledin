...
1. Realiza la implementación de la aplicación `guestbook_django` con apache2 y el mod_wsgi. A la aplicación se acceder con el nombre `guestbook.expamle.org`.
2. Realiza la implementación de la aplicación `tutorial_django` con apache2 y el mod_wsgi. A la aplicación se acceder con el nombre `poll.expamle.org`.
