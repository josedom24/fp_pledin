...
6. Las ramas no se crean automática en GitHub, hay que realizar un `push` para crearlas en remoto. **Nota: `origin` es el nombre del repositorio remoto.** Por lo tanto ejecutamos: 
...
9. Los conflictos aparecen cuando se ha modificado la misma parte de código en dos ramas diferentes. Veamos un ejemplo:
