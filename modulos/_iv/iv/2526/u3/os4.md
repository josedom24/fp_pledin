---
title: "Redes en OpenStack desde el CLI"
---
...
Ahora tenemos que asociar una subred, para ello se pueden indicar los siguientes parámetros:
    ...
    * `--gateway` (**Opcional**): Puerta de enlace que se envía a las instancias si tenemos activo el DHCP. Si no se indica se envía la primera dirección del direccionamiento indicado.
