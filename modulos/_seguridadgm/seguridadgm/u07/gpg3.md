...
Verifica que el documento [`importante.pdf`](importante.pdf) ha sido firmado por mí, para ello puedes obtener la firma del documente en el fichero [`importante.txt.asc`](importante.txt.asc). ¿Necesitas alguna otra cosa para verificar la firma?. ¿Podemos asegurar que el documento no ha sido manipulado?. Razona la respuesta.
